...
const LeetCodeStats = ({ username = 'Aman07122003' }) => {
  return (
    <div className="mx-auto p-3 w-full bg-black/40 md:w-1/2 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg transition-transform duration-300 hover:scale-[1.02]">
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        <h2 className="md:text-lg font-semibold text-white">LeetCode Stats</h2>
        <a
