  ...
  return (
    ...
    >
      <header className="mb-12 flex flex-col">
        ...
        <div className="h-1 w-12 bg-amber-400 rounded-3xl mt-1"></div>
        <div className="flex justify-between">
          <p className="text-gray-400 mt-5 ">Professional journey and qualifications</p>
          <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 p-3 w-40 justify-center rounded-lg bg-gradient-to-r from-amber-500 to-yellow-600 text-white font-medium shadow-lg"
            >
              <IoDownloadOutline />
              Resume
            </motion.button>
      ...
      <div className="grid">
        ...
        <section className="space-y-8">
          ...
          <ol className="space-y-8 relative before:absolute before:top-0 before:bottom-0 before:left-[18px] before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-amber-500/50 before:to-transparent">
              ...
              >
                <div className="absolute left-3 top-19 w-4 h-4 rounded-full bg-amber-500 border-4 border-gray-800 z-10"></div>
                <div className="bg-black/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-amber-500/30 transition-all duration-300">
                  <span className="inline-block px-3 py-1 text-sm font-semibold rounded-full bg-amber-500/20 text-amber-300 mb-2">
                    2022 — 2026
                  </span>
                  <h4 className="text-[25px] font-bold text-white mb-1">Bachlors of Technology in Computer Science</h4>
                  <p className="text-amber-400 font-medium text-[16px] mb-1">Chaudhary Charan Singh University, Meerut (UP)</p>
                  <div className="text-[14px] text-white font-bold"> CGPA :- 9.11</div>
                  <div className="flex flex-wrap gap-2">
                      <span className="text-[12px] px-2 py-1 mt-2 rounded bg-gray-700/50 text-gray-300">
                        Compiler Design
                      </span>
                      <span className="text-[12px] px-2 py-1 mt-2 rounded bg-gray-700/50 text-gray-300">
                        Computer Networking
              ...
              >
                ...
                <div className="bg-black/10  backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-amber-500/30 transition-all duration-300">
                  ...
                  <h4 className="text-[25px] font-bold text-white mb-1">Intermediate (CBSE)</h4>
                  <p className="text-amber-400 font-medium text-[16px] mb-1">Bhagat Public Sr. Sec. School, Kota (Rajasthan)</p>
                  <div className="text-[14px] text-white font-bold"> Percentage :- 79.02% </div>
                  <div className="flex flex-wrap gap-2">
                      <span className="text-[12px] px-2 py-1 mt-2 rounded bg-gray-700/50 text-gray-300">
                        Physics
                      </span>
              ...
              >
                ...
                <div className="bg-black/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-amber-500/30 transition-all duration-300">
                  ...
                  <h4 className="text-[25px] font-bold text-white mb-1">High School (ICSE)</h4>
                  <p className="text-amber-400 font-medium text-[16px] mb-1">St. Theresa's School, Sandila (Uttar Pradesh)</p>
                  <div className="text-[14px] text-white font-bold"> Percentage :- 88.40% </div>
                  <div className="flex flex-wrap gap-2">
                      <span className="text-[12px] px-2 py-1 mt-2 rounded bg-gray-700/50 text-gray-300">
                        English
                      </span>
